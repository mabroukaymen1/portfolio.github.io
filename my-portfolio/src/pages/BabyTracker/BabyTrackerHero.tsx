...
const BabyTrackerHero: React.FC = () => {
    ...
    <section className="py-20 px-6">
      ...
      >
        ...
        <p className="text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
          Supporting parents and healthcare professionals with a comprehensive Flutter interface for monitoring newborn health and development.
        </p>
        
        <div className="flex flex-wrap justify-center gap-4">
          <a 
            href="https://github.com/mabroukaymen1/SoftShot" 
            target="_blank" 
            rel="noopener noreferrer"
            className="px-8 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 hover:scale-105 transition-all shadow-lg shadow-blue-500/20"
          >
            View Code
          </a>
          <button 
...
export default BabyTrackerHero;
