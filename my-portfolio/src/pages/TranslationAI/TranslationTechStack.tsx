...
const technologies = [
  ...
  { name: 'mBART-50', category: 'Base Model' },
  { name: 'HuggingFace', category: 'Transformers' },
  { name: 'SentencePiece', category: 'Tokenizer' },
  { name: 'FastAPI', category: 'API' },
  { name: 'ONNX', category: 'Export' },
  { name: 'Docker', category: 'Container' },
];

const TranslationTechStack: React.FC = () => {
...
export default TranslationTechStack;
