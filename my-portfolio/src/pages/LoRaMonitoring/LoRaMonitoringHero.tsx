...
const LoRaMonitoringHero: React.FC = () => {
    ...
    <section className="py-20 px-6">
      ...
      >
        ...
        <p className="text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
          A low-power, long-range IoT solution for temperature and humidity monitoring using LoRa technology with Firebase cloud integration.
        </p>
        
        <div className="flex flex-wrap justify-center gap-4">
          <a 
            href="https://github.com/mabroukaymen1/loradht" 
            target="_blank" 
...
export default LoRaMonitoringHero;
