...
const features = [
  {
    ...
    description: 'Real-time tracking and management of ships, containers, and operation assignments.',
    icon: 'fa-ship',
    color: 'blue'
  },
  {
    title: 'Equipment Management',
    description: 'Monitor equipment status, schedule maintenance, report failures, and track repairs.',
    icon: 'fa-tools',
    color: 'amber'
  },
  {
    title: 'Employee Workflows',
    description: 'Manage profiles, assign tasks, track attendance, and handle leave requests.',
    icon: 'fa-users',
    color: 'teal'
  },
  {
    title: 'Analytics & Reports',
    description: 'Generate detailed reports on utilization, maintenance, and operation performance.',
    icon: 'fa-chart-line',
    color: 'violet'
  }
];

const PortManagementFeatures: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-slate-50 dark:bg-slate-900/50 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-black uppercase tracking-tighter mb-4">System Modules</h2>
...
export default PortManagementFeatures;
