...
const technologies = [
  ...
  { name: 'Provider', category: 'State Mgmt' },
  { name: 'Cloud Messaging', category: 'Push Notifs' },
  { name: 'REST API', category: 'Integration' },
  { name: 'Firebase Auth', category: 'Security' },
];

const PortManagementTechStack: React.FC = () => {
...
export default PortManagementTechStack;
