...
const PortManagementHero: React.FC = () => {
    ...
    <section className="py-20 px-6">
      ...
      >
        ...
        <p className="text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
          A comprehensive Flutter app for streamlining port operations, equipment maintenance, and employee management with real-time tracking.
        </p>
...
export default PortManagementHero;
